...
window.permissions = function () {
  return {
    checkAll: function checkAll(id, css) {
      document.getElementById(id).checked = Array.from(document.querySelectorAll('.' + css)).every(function (element) {
        return element.checked === true;
      });
    },
    reCheckedSelectAll: function reCheckedSelectAll(el, css) {
